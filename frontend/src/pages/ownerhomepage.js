...
<div className="flex flex-wrap  h-screen">
    ...
    <nav className="flex justify-between bg-teal-600 text-black w-screen">
      <div className="px-5 xl:px-12 py-6 flex w-full items-center">
        ...
        <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
          <li><a className="hover:text-gray-200" href="#">How it Works</a></li>
          <li><a className="hover:text-gray-200" href="#">Locations</a></li>
  ...
  {/* <div className="absolute w-1250 h-540 left-1/2 transform -translate-x-1/2 top-198 rounded-3xl" style={{backgroundImage: "../../public/carimage.jpg"}}></div> */}
</div>
